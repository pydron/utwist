...
latex_documents = [
  ('index', 'python.tex', u'utwist Documentation',
...
man_pages = [
    ('index', 'python', u'utwist Documentation',
...
texinfo_documents = [
  ('index', 'python', u'utwist Documentation',
   u'Stefan C. Mueller', 'python', 'Running twisted\'s reactor inside regular unit-tests without trial',
   'Miscellaneous'),
]
